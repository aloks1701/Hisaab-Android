...
data class Strings(
    ...
    val yearView: String,
    val yearTotal: String,
    val noSpendThisMonth: String,
    val spent: String,
    val received: String,
    val net: String,
    ...
    companion object {
        ...
        private val HI = Strings(
            ...
            months = listOf("जनवरी", "फ़रवरी", "मार्च", "अप्रैल", "मई", "जून",
                "जुलाई", "अगस्त", "सितंबर", "अक्टूबर", "नवंबर", "दिसंबर"),
            // First letters collide badly in Devanagari: ज is both जनवरी and जून, and
            // अ covers अप्रैल, अगस्त and अक्टूबर. Two syllables are the minimum that reads.
            monthsShort = listOf("जन", "फ़र", "मार्च", "अप्रै", "मई", "जून",
                "जुल", "अग", "सित", "अक्तू", "नव", "दिस"),
            monthView = "महीना",
            yearView = "साल",
            yearTotal = "साल भर में",
            noSpendThisMonth = "इस महीने कोई खर्च नहीं।",
            spent = "खर्च",
            received = "मिला",
            net = "नेट बदलाव",
        ...
        private val EN = Strings(
            ...
            monthsShort = listOf("Jan", "Feb", "Mar", "Apr", "May", "Jun",
                "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"),
            monthView = "Month",
            yearView = "Year",
            yearTotal = "This year",
            noSpendThisMonth = "Nothing spent this month.",
            spent = "Spent",
            received = "Received",
            net = "Net change",
